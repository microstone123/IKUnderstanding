...
/* 158 */           hit = Dictionary.matchWithHit(context.getSegmentBuff(), context.getCursor(), hit);
/* 159 */           if (hit.isMatch())
/*     */           {
...
/*     */       }
/*     */ 
/* 177 */       Hit singleCharHit = Dictionary.matchInQuantifierDict(context.getSegmentBuff(), context.getCursor(), 1);
